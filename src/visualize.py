...
class SafePettingZooEnv(PettingZooEnv):
...
def main():
    ...
    while not done:
        ...
        for agent in env.agents:
            ...
            obs_tensor = torch.tensor(obs_np, dtype=torch.float32).unsqueeze(0)  # (1, obs_dim)
            ...
            logits = out["action_dist_inputs"].squeeze(0)  # shape: (N_ACTIONS + N_MESSAGES,)
